...
//http://localhost:27017/api/v1/services/sub_service_settings/en/get_data/1/all
//http://localhost:27017/api/v1/services/sub_service_settings/:langTitle/get_data/:page_number/:suspendStatus
//#endregion
router.route("/:langTitle/get_data/:page_number/:suspendStatus").get(get_Data_By_SuspendStatus)

//#region API Links Explanation
//http://localhost:27017/api/v1/services/sub_service_settings/en/update_data/651beeec4cde306913c4f4a2
//http://localhost:27017/api/v1/services/sub_service_settings/:langTitle/update_data/:id
//#endregion
