...
const {
  ...
  search_data,
//   updateMany_Rows_Data,
} = require("../../controllers/home/dashboard");
 
const router = express.Router();


//http://localhost:27017/api/v1/home/dashboard/en/get_data/1/all
router.route("/:lkp_Table_Name/:langTitle/get_data/:page_number/:suspendStatus").get(get_Data_By_SuspendStatus)

//http://localhost:27017/api/v1/home/dashboard/en/insert_data
 router.route("/:lkp_Table_Name/:langTitle/insert_data").post(create_Row);

//http://localhost:27017/api/v1/home/dashboard/en/update_data/651beeec4cde306913c4f4a2
router.route("/:lkp_Table_Name/:langTitle/update_data/:id").put(update_Data);

//http://localhost:27017/api/v1/home/dashboard/en/update_many_rows/activate
router.route("/:lkp_Table_Name/:langTitle/update_many_rows/:status").put(updateMany_Rows_Data);

//http://localhost:27017/api/v1/home/dashboard/en/search_data/all
