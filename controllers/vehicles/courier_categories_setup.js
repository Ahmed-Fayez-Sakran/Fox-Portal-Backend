...
const tbl_Service = require("../../services/courier_categories_setup");
var tbl_Model = require("../../models/courier_categories_lkp");
var langTitle = "";
var recievedData = ""
    ...
    try {
        ...
        let get_Message_Promise = new Promise(async (resolve, reject)=>{
            ...
            if (suspendStatus=="only-true"){
                result = await fun_handled_messages.get_handled_message(langTitle,138);
            }else if(suspendStatus=="only-false"){
                result = await fun_handled_messages.get_handled_message(langTitle,139);
            }else if(suspendStatus=="all"){
                result = await fun_handled_messages.get_handled_message(langTitle,140);
            }else{
...
exports.Insert_New_Courier_Categor =  async(req, res) => {

    try {
        //#region Global Variables
        langTitle = req.params.langTitle;
        var val_Serial_Number = req.body.Serial_Number;
        var val_Category_Title_En = req.body.Category_Title_En;
        var val_Category_Title_Ar = req.body.Category_Title_Ar;
        ...
        let check_Ar_Title_Existancy_Promise = new Promise(async (resolve, reject)=>{
            var returnedList = await fun_check_existancy.check_title_existancy("courier_categories_lkp" , "" , "insert" , "ar" , val_Category_Title_Ar , "" , "" );
            resolve(returnedList);
        });

        let check_En_Title_Existancy_Promise = new Promise(async (resolve, reject)=>{
            var returnedList = await fun_check_existancy.check_title_existancy("courier_categories_lkp" , "" , "insert" , "en" , val_Category_Title_En , "" , "" );
            resolve(returnedList);
        });
        ...
        Promise.all([check_Ar_Title_Existancy_Promise , check_En_Title_Existancy_Promise]).then((results) => {
            ...
            if (results[0]==true && results[1]==true) {
                ...
                new Promise(async (resolve, reject)=>{
                    var msg = await fun_handled_messages.get_handled_message(langTitle,195);
                    resolve(msg)
                }).then((msg) => {
                    msg = msg.replace("Category_Title_Ar", val_Category_Title_Ar);
                    msg = msg.replace("Category_Title_En", val_Category_Title_En);
                ...
                new Promise(async (resolve, reject)=>{
                    var msg = await fun_handled_messages.get_handled_message(langTitle,196);
                    resolve(msg)
                }).then((msg) => {
                    msg = msg.replace("Category_Title_Ar", val_Category_Title_Ar);
                    res.status(200).json({ data:[], message: msg, status: "already exist" });
                ...
                new Promise(async (resolve, reject)=>{
                    var msg = await fun_handled_messages.get_handled_message(langTitle,197);
                    resolve(msg)
                }).then((msg) => {
                    msg = msg.replace("Category_Title_En", val_Category_Title_En);
                    res.status(200).json({ data:[], message: msg, status: "already exist" });
                ...
                //#region prepare Data Object for insertion
                 let sentData = new tbl_Model({
                    ...
                    Category_Title_En: req.body.Category_Title_En,
                    Category_Title_Ar: req.body.Category_Title_Ar,
                ...
                //#region insert process
                    new Promise(async (resolve, reject)=>{
                        const newList = await fun_insert_row.insert_row("courier_categories_lkp",sentData);
                        resolve(newList);
                    }).then((inserted_Flag) => {
                        if (!inserted_Flag) {
                            ...
                            new Promise(async (resolve, reject)=>{
                                var result = await fun_handled_messages.get_handled_message(langTitle,198);
                                resolve(result);
                            }).then((msg) => {
                                if (langTitle=="en") {
                                    msg = msg.replace("Category_Title_En", val_Category_Title_En);
...
exports.update_Row =  async(req, res) => {
    ...
    try {
        ...
        new Promise(async (resolve, reject)=>{
            var exist = await fun_check_Existancy_By_ID.check_Existancy_By_ID("courier_categories_lkp",val_ID);
            resolve(exist);
        }).then((id_Exist) => {
            if (!id_Exist) {
                ...
                let check_Ar_Title_Existancy_Promise = new Promise(async (resolve, reject)=>{
                    var returnedList = await fun_check_existancy.check_title_existancy("courier_categories_lkp" , val_ID , "update" , "ar" , val_Category_Title_Ar , "" , "" );
                    resolve(returnedList);
                });

                let check_En_Title_Existancy_Promise = new Promise(async (resolve, reject)=>{
                    var returnedList = await fun_check_existancy.check_title_existancy("courier_categories_lkp" , val_ID , "update" , "en" , val_Category_Title_En , "" , "" );
                    resolve(returnedList);
                });
                ...
                Promise.all([check_Ar_Title_Existancy_Promise , check_En_Title_Existancy_Promise]).then((results) => {
                    ...
                    if (results[0]==true && results[1]==true) {
                        ...
                        new Promise(async (resolve, reject)=>{
                            const newList = await fun_update_row.update_row(val_ID, "courier_categories_lkp", recievedData , false);
                            resolve(newList);
                        }).then((update_flg) => {
                            if (!update_flg) {
                                ...
                                //#region msg update process successed
                                    new Promise(async (resolve, reject)=>{
                                        var result = await fun_handled_messages.get_handled_message(langTitle,199);
                                        resolve(result);
                                    }).then((msg) => {
                                        if (langTitle=="en") {
                                            msg = msg.replace("Category_Title_En", val_Category_Title_En);
...
exports.update_Suspend_Status_One_Row =  async(req, res) => {
    ...
    try {
        ...
        new Promise(async (resolve, reject)=>{
            let returnedList = await fun_check_Existancy_By_ID.check_Existancy_By_ID("courier_categories_lkp",val_ID);
            resolve(returnedList);
        }).then((returned_ID) => {
            if (!returned_ID) {
                //#region ID is not exist in DB msg 14
                    ...
                    new Promise(async (resolve, reject)=>{
                        ...
                        if (!update_flg) {
                            ...
                            new Promise(async (resolve, reject)=>{
                                let result=""
                                if (status=="activate") {
                                    result = await fun_handled_messages.get_handled_message(langTitle,200);
                                } else {
...
exports.update_Suspend_Status_Many_Rows =  async(req, res) => {
    ...
    try {
        ...
        new Promise(async (resolve, reject)=>{
            let returnedList = await fun_check_Existancy_By_List_IDS.check_Existancy_By_List_IDS("courier_categories_lkp",req.body.data);
            resolve(returnedList);
        }).then((returned_ID) => {
            if (!returned_ID) {
                //#region ID is not exist in DB msg 14
                ...
                if ( (status!="activate") && (status!="suspend") ){
                    ...
                    //#region update process
                    new Promise(async (resolve, reject)=>{
                        var exist = await fun_Update_Suspend_Status_Many_Rows.Update_Suspend_Status_Many_Rows(status , req.body.data , val_Updated_By , "courier_categories_lkp");
                        resolve(exist);
                        ...
                        if (!Records_Updated) {
                            ...
                            new Promise(async (resolve, reject)=>{                            
                                let result=""
                                if (status=="activate") {
                                    result = await fun_handled_messages.get_handled_message(langTitle,202);
                                } else {
                                    result = await fun_handled_messages.get_handled_message(langTitle,203);
                                }
                                resolve(result);
                            }).then((msg) => {
