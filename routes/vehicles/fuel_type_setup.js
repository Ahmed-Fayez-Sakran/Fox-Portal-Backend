...
} = require("../../controllers/vehicles/fuel_type_setup");
 
const router = express.Router();


//#region API Links Explanation
//http://localhost:27017/api/v1/vehicles/fuel_type_setup/en/get_data/1/all
//http://localhost:27017/api/v1/vehicles/fuel_type_setup/:langTitle/get_data/:page_number/:suspendStatus
//#endregion
...
//http://localhost:27017/api/v1/vehicles/fuel_type_setup/:langTitle/update_data/:id
//#endregion
router.route("/:langTitle/update_data/:id").put(update_Row);

//#region API Links Explanation
//http://localhost:27017/api/v1/vehicles/fuel_type_setup/en/update_suspend_status_one_row/activate
//http://localhost:27017/api/v1/vehicles/fuel_type_setup/:langTitle/update_suspend_status_one_row/:status
//#endregion
router.route("/:langTitle/update_suspend_status_one_row/:status").put(update_Suspend_Status_One_Row);

//#region API Links Explanation
//http://localhost:27017/api/v1/vehicles/fuel_type_setup/en/update_suspend_status_many_rows/activate
//http://localhost:27017/api/v1/vehicles/fuel_type_setup/:langTitle/update_suspend_status_many_rows/:status
//#endregion
