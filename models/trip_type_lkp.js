...
const Trip_Type_LKP_Schema = mongoose.Schema({
...
}, { collection: 'Trip_Type_LKP' })

Trip_Type_LKP_Schema.virtual('id').get(function () {
    return this._id.toHexString();
});

Trip_Type_LKP_Schema.set('toJSON', {
    virtuals: true,
});

module.exports = mongoose.model('Trip_Type_LKP', Trip_Type_LKP_Schema);
